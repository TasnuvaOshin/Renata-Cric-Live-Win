package cricketworldcup.icccricketworldcup.UserEnd.More.MatchPrediction;
...
public class MatchPredictionFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_match_prediction, container, false);
        banner = view.findViewById(R.id.iv_banner_adstop);
        bannerRef = FirebaseDatabase.getInstance().getReference().child("Banner").child("matchprediction").child("sectionone");

        bannerRef2 = FirebaseDatabase.getInstance().getReference().child("Banner").child("matchprediction").child("sectionzero");
        ...
        dn.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                qno = String.valueOf(dataSnapshot.child("match_prediction_no").getValue());
                CheckStatus();
            }
        ...
        submitDb = FirebaseDatabase.getInstance().getReference().child("Match_Prediction_participant");
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Match_Prediction_Live");
        SetUpQuiz();
        ShowBannerAds();
        ...
        df.child(firebaseAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (type.equals("0")) {
                    ...
                    ShowtypeZero();
                    // bannertop.setImageResource(R.drawable.fenadin);

                } else {

                    ShowtypeOne();
                    //  bannertop.setImageResource(R.drawable.taven);
                }
