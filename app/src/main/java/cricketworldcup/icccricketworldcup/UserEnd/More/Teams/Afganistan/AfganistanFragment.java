package cricketworldcup.icccricketworldcup.UserEnd.More.Teams.Afganistan;
...
public class AfganistanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bundle = new Bundle();
        View view = inflater.inflate(R.layout.fragment_afganistan, container, false);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("squad").child("AFGHANISTAN");
            ...
            protected void onBindViewHolder(@NonNull squad_view_holder holder, int position, @NonNull final squad_model model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        bundle.putString("team","AFGHANISTAN");
